  ...
  return (
    <>
          ...
          <>
            <div className={`${styles[`c${i}`]}`} key={`mypuzzle_${i}`}>
              <PuzzleSegment
                ...
                segmentState={mySegmentState.segmentState}
                isRightCard={false}
              />
            </div>
          </>
      ...
      <div className="absolute grid w-[640px] h-[480px] mt-[100px]" style={{ pointerEvents: "none" }}>
        ...
        {mySegmentState.segmentState === "ice" && (
          <div id="myice" className={`flex fill`} style={{ pointerEvents: "none" }}>
            {" "}
            <img src="../images/icemine.gif" className={`z-50 ${styles.gif}`} draggable="false" style={{ pointerEvents: "none" }} />{" "}
          </div>
        )}
        {mySegmentState.segmentState === "magnet" && (
        ...
        {mySegmentState.segmentState === "lip" && (
          <div id="mylip" className={`flex fill`} style={{ pointerEvents: "none" }}>
            {" "}
            <img src="../images/lipmine.gif" className={`z-50 ${styles.gif2}`} draggable="false" style={{ pointerEvents: "none" }} />{" "}
          </div>
        )}
        {mySegmentState.segmentState === "twirl" && (
          <div id="mytwirl" className={`flex fill`} style={{ pointerEvents: "none" }}>
            {" "}
          </div>
        )}
        {mySegmentState.segmentState === "rocket" && (
          <div id="myrocket" className={`flex fill`} style={{ pointerEvents: "none" }}>
            {" "}
            <img src="../images/rocketmine.gif" className={`z-50 ${styles.gif}`} draggable="false" style={{ pointerEvents: "none" }} />{" "}
          </div>
        )}
      </div>
